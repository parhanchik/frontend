...
class ConfirmPage extends React.Component {
    ...
    render() {
        ...
        const { username, password, code, submitted } = this.state;
        return (
...
const connectedLoginPage = connect(mapState, actionCreators)(ConfirmPage);
export { connectedLoginPage as ConfirmPage };